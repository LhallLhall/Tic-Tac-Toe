...
function drawBoard(){
    ...
    let col3 = createAndAddElement(row1, 'button', ['col-4', 'p-5','border','d-flex', 'justify-content-center', 'align-items-center', 'border-start-0', 'border-success','btnOpacity','border-3'],'col3','' )
    let col4 = createAndAddElement(row1, 'button', ['col-4', 'p-5','border','d-flex', 'justify-content-center', 'align-items-center', 'border-success','btnOpacity','border-3'],'col4','' )
    let col5 = createAndAddElement(row1, 'button', ['col-4', 'p-5','border','d-flex', 'justify-content-center', 'align-items-center', 'border-end-0', 'border-success','btnOpacity','border-3'],'col5','' )
